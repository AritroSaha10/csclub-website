...
export default function Footer() {
    return (
        <footer className="flex flex-col gap-3 p-4 bg-black">
                ...
                <p className="text-gray-400 text-sm text-center">Made by <a href="https://www.aritrosaha.ca/" className="text-blue-500 hover:text-blue-700 duration-200">Aritro Saha</a> and Arya Holmukhe</p>
        </footer>
    );
}