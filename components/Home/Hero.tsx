                ...
                <div className="text-center">
                    <div className="mb-4">
                        <motion.div variants={lineVariants} initial="initial" animate="animate" className="font-bold flex flex-col flex-wrap gap-2 text-6xl sm:text-7xl lg:text-9xl">
                            {bottomLine.map(char => <motion.span className="inline-block relative bg-clip-text text-transparent bg-gradient-to-r from-[#00539C] to-[#8EB8E5] pb-5" variants={characterVariants} key={char}>{char}</motion.span>)}
                        </motion.div>
                    </div>
                </div>

                <motion.div variants={subtitleVariants} initial="initial" animate="animate" className="flex flex-col gap-2 text-white text-3xl font-light text-center mb-6 md:w-3/4 lg:w-1/3">
